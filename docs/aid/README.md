...
## How to create an AID

### 1. Copy the template

```bash
cp docs/aid/template/AID-TEMPLATE.md docs/aid/AID-XXXX-short-description.md
```

### 2. Fill in the sections

- **Goal** — what problem or task prompted the interaction
- **Prompt summary** — what was asked (include key prompt text or link to prompt file)
- **AI output summary** — what was produced
- **Evaluation** — how the output was assessed
- **Outcome** — what was adopted / modified / rejected and why
- **Project impact** — what changed as a result
...
### 4. Reference from related ADRs

If the AID resulted in a decision that is also captured in an ADR, add a reference:

```markdown
- Related AID: [AID-XXXX](../aid/AID-XXXX-short-description.md)
```
